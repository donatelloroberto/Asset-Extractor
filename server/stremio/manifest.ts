...
> = {
  ...
  "gxtapes-lucasentertainment": {
    path: "/571476/",
    name: "GXT-LucasEntertainment",
  },
  ...
  "gxtapes-cuminside": {
    path: "/cum-inside-creampie-145670/",
    name: "GXT-Cum Inside",
  },
  "gxtapes-groupsex": {
    path: "/groupsex-gangbang-porn-129457/",
    name: "GXT-Group Sex",
  },
...
export function buildManifest(): StremioManifest {
  const catalogs: StremioManifest["catalogs"] = Object.entries(CATALOG_MAP).map(
    ([id, { name }]) => ({
      type: "movie",
      id,
      name,
  ...
  return {
    ...
    name: "GXtapes",
    description:
      "GXtapes content provider for Stremio - converted from Cloudstream 3 extension",
